...
public class CameraController : MonoBehaviour
{
    ...
    private Tractor_Handler tractorHandler;
    ...
    void Start()
    {
        ...
        // ✅ Get Tractor_Handler
        tractorHandler = tractor.GetComponent<Tractor_Handler>();
    }
    ...
    void LateUpdate()
    {
        ...
        // ✅ Update bobbing if tractor is moving
        bool isMoving = tractorHandler != null && 
                        (Mathf.Abs(tractorHandler.verticalInput) > 0.1f || Mathf.Abs(tractorHandler.horizontalInput) > 0.1f);
        ...
        if (Input.GetMouseButton(1))
        {
            ...
            Vector3 desiredPos = tractor.position + tractor.rotation * offset + new Vector3(0, currentBobOffset, 0);
        ...
        Vector3 desiredPosition = tractor.position + rotatedOffset + new Vector3(0, currentBobOffset, 0);

        // Smooth camera follow
        transform.position = Vector3.Lerp(transform.position, desiredPosition, smoothSpeed);

        // Face tractor with downward tilt
