...
public class FarmStandScript : MonoBehaviour
{
    ...
    void OnTriggerEnter(Collider other)
    {
        ...
        {
            GameManager.Instance.currentPhase = GameManager.Phase.Phase5; // Advance to Phase 5
    ...
    public void backToPhaseOne()
    {
        ...
        GameManager.Instance.ResetGame(); // Assuming you have a method to reset the game state
